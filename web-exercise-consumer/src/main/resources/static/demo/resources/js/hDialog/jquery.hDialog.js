...
;(function($, window, document, undefined) {	
	...
	methods = {
        ...
        open: function (o,T) {
			...
			//遮罩背景层
			if(o.isOverlay != false) overlayTpl = "<div id='HOverlay' style='width:"+$D.width()+"px;height:"+$D.height()+"px;background-color:"+modalBg+";position:fixed;top:0;left:0;z-index:999998;'></div>";
	    ...
	    close: function (o,T) {
	    		//var $obj = (o.autoShow != false) ? T : $(o.box); (此处有错！)
				var $obj = {};
				if(typeof(o.autoShow) == 'undefined' ||  o.autoShow == false){
					$obj = $(o.box);
				}else{
					$obj = T;
				}
	...
	*/
	$.extend({  
        ...
        tooltip: function (t1, t2, t3, callback) {
        		...
        		var tip = '<div class="HTooltip shake animated" style="width:280px;padding:10px;text-align:center;background-color:#D84C31;color:#fff;position:fixed;top:150px;left:50%;z-index:1000010;margin-left:-150px;box-shadow:1px 1px 5px #333;-webkit-box-shadow:1px 1px 5px #333;">'+t1+'</div>';
	    		if(t3 == true && t3 != undefined) { tip = '<div class="HTooltip bounceInDown animated" style="width:280px;padding:10px;text-align:center;background-color:#5cb85c;color:#fff;position:fixed;top:150px;left:50%;z-index:1000010;margin-left:-150px;box-shadow:1px 1px 5px #333;-webkit-box-shadow:1px 1px 5px #333;">'+t1+'</div>'; }
