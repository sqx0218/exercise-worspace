$(function () {
	...
	function n() {
		...
		$("#maskblack").fadeOut(300, function () {
			$("#maskblack").remove();
	...
	$(".ogrid .navlist").bind("touchstart", function () {
	...
	3 >= $(".searchtags li").length && $(".cates li").click(function () {
		...
		a = [];
		for (b = 0; b < $(".cates li.selected").length; b++)
			a.push($(".cates li.selected").eq(b).attr("data-href"));
		window.location.href = $("#select").attr("data-href") + a.join("&")
	});
	$(".closetag").click(function () {
		$(this).parent().data("target").removeClass("selected");
		for (var a = [], b = 0; b < $(".cates li.selected").length; b++)
			a.push($(".cates li.selected").eq(b).attr("data-href"));
		window.location.href = $("#select").attr("data-href") + a.join("&")
	});
	...
	$("#index_list_round").hover(function () {
		...
		if (!c)
			return $(".index_list_arrow_prev").addClass("index_list_cur"), $(".index_list_arrow_next").addClass("index_list_cur"), $(".index_list_info").stop().css("bottom", -70), !1;
	...
	$(".loginusername3").placeholder();
	$(".loginusername4").placeholder();
	...
	$("#postbtn.sitemessage").click(function (a) {
		...
		if (!a.title)
			return alert("\u540d\u5b57\u4e0d\u80fd\u4e3a\u7a7a"), !1;
		a.email = $.trim($("#youremail").val());
		if (!a.email)
			return alert("\u90ae\u7bb1\u4e0d\u80fd\u4e3a\u7a7a"), !1;
		if (!/^[\w\.\-\+]+@([\w\-]+\.)+[a-z]{2,4}$/i.test(a.email))
			return alert("\u90ae\u7bb1\u683c\u5f0f\u4e0d\u6b63\u786e"), !1;
