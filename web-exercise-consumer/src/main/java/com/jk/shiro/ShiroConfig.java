...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
        ...
        sfb.setLoginUrl("/login/tologin");//设置登录页面的地址，默认login页面
        ...
        map.put("/login/loginUser", "anon");
        map.put("/login/quindex", "anon");
        map.put("/login/login", "anon");
        map.put("/login/tokjdl", "anon");
        map.put("/login/gainCodeMsg", "anon");
        //放开静态资源
        map.put("/denglu/**", "anon");
        map.put("/js/**", "anon");
        map.put("/kjdl/**", "anon");
